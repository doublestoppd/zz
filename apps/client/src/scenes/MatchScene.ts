...
import { decideMoveIntent } from "../input/moveIntent.js";
...
/** The only Phaser scene. Renders from the store and turns tile clicks into move intents. */
export class MatchScene extends Phaser.Scene {
  ...
  private handleClick(pointer: Phaser.Input.Pointer): void {
    ...
    const command = decideMoveIntent(client.game.state, client.me.playerId, tile);
